...
export const parseUpdateManifest = (data: string): v.InferOutput<typeof UpdateManifestSchema> => v.parse(UpdateManifestSchema, data);
...
export const parseUpdateConfig = (data: string): v.InferOutput<typeof UpdateConfigSchema> => v.parse(UpdateConfigSchema, data);
